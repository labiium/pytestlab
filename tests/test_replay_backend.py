    ...
    return {
        "psu": {
            ...
            "log": [
                ...
                {"type": "write", "command": "CURR 0.1, (@1)", "timestamp": 0.7136540680075996},
                {
                    "type": "query",
                    "command": "MEAS:VOLT? (@1)",
...
class TestReplayBackend:
    ...
    def test_complete_successful_sequence(self, replay_backend):
        ...
        assert (
            idn_result == "Keysight Technologies,EDU36311A,CN61130056,K-01.08.03-01.00-01.08-02.00"
        )
...
def test_replay_mismatch_error_attributes():
    ...
    error = ReplayMismatchError(
        message="Test error", expected_command="*IDN?", actual_command="*TST?", log_index=5
    )
...
class TestReplayBackendEdgeCases:
    ...
    def empty_session_data(self):
        ...
        return {"psu": {"profile": "keysight/EDU36311A", "log": []}}
