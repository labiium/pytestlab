...
osc = Oscilloscope(profile=oscilloscope_profile["DSOX1204G"])
awg = WaveformGenerator(profile=awg_profile["EDU33212A"])
psu = PowerSupply(profile=power_supply_profile["EDU36311A"])
dmm = Multimeter(profile=multimeter_profile["EDU34450A"])
