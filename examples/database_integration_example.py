...
async def run_experiment(name, description, base_voltages, collector_range):
    ...
    async with await Bench.open_from_dict(bench_config) as bench:
...
async def run_multiple_experiments():
    ...
    experiment1 = await run_experiment(
    ...
    experiment2 = await run_experiment(
...
async def main():
    ...
    experiment1, experiment2 = await run_multiple_experiments()
