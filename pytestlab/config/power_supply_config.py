...
class PowerSupplyConfig(InstrumentConfig):
    def __init__(self, manufacturer, vendor_id, product_id, model, device_type, outputs, total_power, line_regulation, load_regulation, programming_accuracy, readback_accuracy, interfaces, remote_control):
