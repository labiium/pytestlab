...
class OscilloscopeConfig(InstrumentConfig):
    ...
    function_generator: FunctionGenerator | None = Field(None, description="Integrated function generator capabilities, if available")
    franalysis: FRAnalysis | None = Field(None, description="Frequency Response Analysis capabilities, if available")
    timebase_settings: Timebase | None = Field(None, description="Global timebase settings, if applicable beyond per-channel")
