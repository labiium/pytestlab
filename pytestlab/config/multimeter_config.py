...
class MultimeterConfig(InstrumentConfig):
    def __init__(self, manufacturer, model, device_type, serial_number, resolution, max_voltage, max_resistance, max_current, max_capacitance, max_frequency, configuration):
