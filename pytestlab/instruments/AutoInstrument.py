...
class AutoInstrument:
    ...
    @classmethod
    def from_type(cls, instrument_type, *args, **kwargs):
    ...
    @classmethod
    def from_config(cls, identifier, debug_mode=False):
    ...
    @classmethod
    def register_instrument(cls, instrument_type, instrument_class):
        if instrument_type in cls._instrument_mapping:
